...
import { ConfirmRegistrationInputDto } from '../../../src/modules/user-accounts/auth/api/input-dto/confirm-registration.input-dto';
import { NewPasswordInputDto } from '../../../src/modules/user-accounts/auth/api/input-dto/new-password.input-dto';
import { PasswordRecoveryInputDto } from '../../../src/modules/user-accounts/auth/api/input-dto/password-recovery.input-dto';
import { ResendRegistrationInputDto } from '../../../src/modules/user-accounts/auth/api/input-dto/resend-registration.input-dto';
